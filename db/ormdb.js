...
//         var queryString = 'DELETE FROM rides WHERE id = ' + uID; 
...
//         var queryString = 'SELECT * FROM rides WHERE userId = ' + uID; 
...
//         console.log('uID: ' + uID);
//         var queryString = 'INSERT INTO rides(userId,invName,invDesc,invGroup,invWSP,invRTP,invStock,invMRP) VALUES (?,?,?,?,?,?,?,?)';
